...
if (($_POST['xyz_cfm_SmtpHostName']!= "") && ($_POST['xyz_cfm_SmtpEmailAddress'] != "") && ($_POST['xyz_cfm_SmtpPassword'] != "") && 
		($_POST['xyz_cfm_SmtpPortNumber']!= "") && ($_POST['xyz_cfm_SmtpSecuirity']!= "")){
			...
			if(empty($xyz_cfm_smtpAccountCount)){
			...
			?><script>
			document.location.href="admin.php?page=contact-form-manager-manage-smtp&smtpmsg=7";
			</script>
			<?php
			exit();
...
<h2>SMTP</h2>
	...
	<table class="widefat"  style="width:99%;">
			...
			<tr valign="top">
				...
				<td ><input  name="xyz_cfm_SmtpPortNumber" type="text" id="xyz_cfm_SmtpPortNumber" value="<?php if(isset($_POST['xyz_cfm_SmtpPortNumber']) ){echo esc_attr($_POST['xyz_cfm_SmtpPortNumber']);}else{echo "25";}?>" />
				</td>
			</tr>
			<tr valign="top">
