...
if(isset($_GET['pagenum'])){
	$pageNumber = intval($_GET['pagenum']);
	
}
$xyz_cfm_smtpMessage = '';
if(isset($_GET['smtpmsg'])){
	$xyz_cfm_smtpMessage = intval($_GET['smtpmsg']);
		...
		<fieldset
			...
			<table class="widefat" style="width: 99%; margin: 0 auto;border-bottom:none;">
				...
				if($entry->status == 0){
					 ...
					 $bare_url=admin_url('admin.php?page=contact-form-manager-manage-smtp&action=smtp-block&id='.$entry->id.'&status=1&pageno='.$pageno); ?>
					
						
					
						<td style="text-align: center;"><a
							href='<?php echo wp_nonce_url( $bare_url, 'status-smtp_'.$entry->id );?>'><img
				...
				<?php $bare_url= admin_url('admin.php?page=contact-form-manager-manage-smtp&action=smtp-activate&id='.$entry->id.'&status=0&pageno='.$pageno);										 ?>
				...
				// $bare_url=admin_url('admin.php?page=contact-form-manager-manage-smtp&action=smtp-edit&id='.$entry->id.'&pageno='.$pageno); ?>
						...
						<?php $bare_url=admin_url('admin.php?page=contact-form-manager-manage-smtp&action=smtp-delete&id='.$entry->id.'&pageno='.$pageno);
						 ?>
						<td style="text-align: center;" ><a
