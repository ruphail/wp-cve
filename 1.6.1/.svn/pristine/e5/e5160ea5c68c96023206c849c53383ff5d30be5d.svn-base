...
if(get_option('xyz_cfm_layout_setting')==1)
{
...
$xyz_cfm_pageCodeDefault ='<table style="width:100%;">
		<tr>
		<td>Your Name '.$nameCode.'</td>
				</tr>
				<tr>
				<td>Your Email '.$emailCode.'</td>
						</tr>
						<tr>
						<td>Subject '.$xyz_cfm_subjectCode.'</td>
								</tr>
								<tr>
								<td>Message Body '.$messageCode.'</td>
										</tr>
										<tr>
										<td>'.$submitCode.'</td>
												</tr>
...
?>
<script>
document.location.href="admin.php?page=contact-form-manager-managecontactforms&action=form-edit&id=<?php echo $lastid?>";
</script>
