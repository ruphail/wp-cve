...
if (
		...
		|| ! wp_verify_nonce( $_POST['_wpnonce'],'load_element_details' )
) {
	wp_nonce_ays( 'load_element_details');
...
jQuery('#textFieldButtonUpdate1').click(function() {
	...
	if(jQuery('#requiredUpdate1').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
	...
	var update_nonce= '<?php echo wp_create_nonce('update_elements');?>';
...
jQuery('#textFieldButtonUpdate2').click(function() {
	...
	if(jQuery('#requiredUpdate2').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate3').click(function() {
	...
	if(jQuery('#requiredUpdate3').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate4').click(function() {
	...
	if(jQuery('#requiredUpdate4').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
	if(jQuery('#viewMultipleSelectDropDownUpdate').prop('checked') == true){
		multipleSelect = 1;
	}else{
		multipleSelect = 0;
	}
...
jQuery('#textFieldButtonUpdate5').click(function() {
	...
	if(jQuery('#requiredUpdate5').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate6').click(function() {
	...
	if(jQuery('#requiredUpdate6').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate7').click(function() {
	...
	if(jQuery('#requiredUpdate7').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate8').click(function() {
	...
	if(jQuery('#requiredUpdate8').prop('checked') == true){
		required = 1;
	}else{
		required = 0;
	}
...
jQuery('#textFieldButtonUpdate10').click(function() {
	...
	if(jQuery('#reCaptchaUpdate').prop('checked') == true){
		var reCaptcha =  1;
	}
	else{
			var reCaptcha =  0;
