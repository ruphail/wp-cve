			...
			<table class="widefat" style="width: 99%; margin: 0 auto; border-bottom:none;">
				...
				<tbody>
					...
					<tr <?php echo $class; ?>>
						...
						<?php $bare_url=admin_url('admin.php?page=contact-form-manager-managecontactforms&action=form-delete&id='.$entry->id.'&pageno='.$pagenum);
						 ?>
						<td style="text-align: center;" ><a
							href='<?php echo wp_nonce_url( $bare_url, 'trash-form_'.$entry->id ); ?>'
